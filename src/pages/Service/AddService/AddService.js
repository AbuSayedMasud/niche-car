                    ...
                    <div className=" col-10  shadow-lg rounded-3 p-3 p-sm-4 header-bg ">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="form-floating mb-2">
                                ...
                                <span style={errors.description ? visibile : invisibile} className='text-danger ps-2' >* Enter Description</span>
                            </div>
                            <div className="form-floating mb-2">
                            ...
                            <div className="form-floating mb-2">
                                ...
                                <span style={errors.img ? visibile : invisibile} className='text-danger ps-2' >* Enter the image url</span>
                            </div>
